                        ...
                        <div class="m-1 rounded shadow-sm d-flex flex-column col">
                            <div class="m-3 rounded shadow card mw-100">
                                <div class="mt-1 card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ Route('surat.sktm') }}" class="card-link btn btn-primary">Lihat</a>
                                    </div>
                            ...
                            <div class="m-3 rounded shadow card mw-100">
                                <div class="mt-1 card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ Route('surat.skd') }}" class="card-link btn btn-primary">Lihat</a>
                                    </div>
                            ...
                            <div class="m-3 rounded shadow card mw-100">
                                <div class="mt-1 card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ Route('surat.skpp') }}" class="card-link btn btn-primary">Lihat</a>
                                    </div>
